...
- Matches the feature concept: the browser is app-level navigation that opens queries into _new tabs_.
...
**Decision:** Implement git-based workspaces via a _pluggable backend interface_, with the initial “reference” backend targeting Git hosting provider HTTP APIs (e.g., GitHub/GitLab) rather than raw git protocol.
